        ...
        <section id="projects" className="py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-card border border-border rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-500 hover:shadow-xl hover:shadow-primary/20 backdrop-blur-sm">
                <div className="aspect-video bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 relative group overflow-hidden">
                  <a href="https://pay.coins-colombia.com/auth/login" target="_blank" rel="noopener noreferrer">
                    <Image
                      src="/images/coinspay-preview.png"
                ...
                <div className="p-6 space-y-4 relative z-10 bg-gradient-to-b from-transparent via-card to-card">
                  <h3 className="text-xl font-semibold mb-2">
                    <a href="https://pay.coins-colombia.com/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                      {"CoinsPay (WIP)"}
                    </a>
                  </h3>
              ...
              <div className="bg-card border border-border rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-500 hover:shadow-xl hover:shadow-primary/20 backdrop-blur-sm">
                ...
                <div className="p-6 space-y-4 relative z-10 bg-gradient-to-b from-transparent via-card to-card">
                  <h3 className="text-xl font-semibold mb-2">
                    <a href="https://spotify-clone-seven-tau-16.vercel.app" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                      {"Spotify Clone"}
                    </a>
                  </h3>
                  <p className="text-foreground/80 mb-4">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
              <div className="flex flex-col items-center p-6 bg-card rounded-lg shadow-sm border border-border">
                ...
                <p className="text-center text-foreground/80">React, Vite, Next.js</p>
              </div>
              <div className="flex flex-col items-center p-6 bg-card rounded-lg shadow-sm border border-border">
                <div className="text-4xl mb-4">⚙️</div>
                <h3 className="text-lg font-semibold mb-2">Backend</h3>
                <p className="text-center text-foreground/80">Node.js, Nest.js, SQL</p>
              </div>
            ...
            <div className="flex flex-col items-center p-6 bg-card rounded-lg shadow-sm border border-border">
              ...
              <p className="text-center text-foreground/80">Git, Docker, AWS</p>
            </div>
            </div>
          </div>
        </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-lg mx-auto">
            <div className="flex flex-col items-center space-y-6">
              <a href="mailto:jepierre.dev@hotmail.com" className="flex items-center space-x-3 text-lg hover:text-primary transition-colors">
                <span>📧</span>
                <span>jepierre.dev@hotmail.com</span>
              </a>
              <div className="flex space-x-6">
                <a href="https://github.com/Jepierre88" target="_blank" rel="noopener noreferrer" className="text-2xl hover:text-primary transition-colors">GitHub</a>
                <a href="https://www.linkedin.com/in/jean-ortiz-60460427a" target="_blank" rel="noopener noreferrer" className="text-2xl hover:text-primary transition-colors">LinkedIn</a>
